...
public class BuildingReport {
  ...
  /**
   * This method is used to output a string representation of the building report.
   *
   * @return a string representation of the building report.
   */
  @Override
  public String toString() {
    StringBuilder elevatorReport = new StringBuilder();
    for (ElevatorReport report : elevatorReports) {
      elevatorReport.append(report.toString()).append("\n");
    }
    return "Requests waiting to be processed:\n"
        + "Up Requests: " + upRequests + "\n"
        + "Down Requests: " + downRequests + "\n"
